...
public struct Tar {
  ...
  @discardableResult
  fileprivate static func writeFileDataFor(_ data: Data, atLocation: Int, withLength: Int, atPath: String) -> Bool {
    return FileManager.default.createFile(atPath: atPath, contents: data.subdata(in: atLocation..<(atLocation+withLength)), attributes: nil)
  }
